...
\begin{enumerate}
    \item Generate MC events for signal and background and load the \href{https://github.com/lorenzennio/icsc-bayesian-inference/blob/main/LHC_data.txt}{data}. %provide this
